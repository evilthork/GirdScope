...
- `0.7.9`: reapertura visible y verificada de la aplicación después de
  actualizar.
...
- `GridScope-0.7.9-Windows.zip`
- `GridScope-0.7.9-Source.zip`
...
2. Crea la etiqueta `v0.7.9`.
3. Sube la rama y la etiqueta al repositorio.
4. Abre **Releases → Draft a new release**.
5. Selecciona `v0.7.9` y marca la versión como **Pre-release**.
