...
- `0.7.2`, `0.7.3`…: correcciones que no cambian el funcionamiento básico.
...
- `GridScope-0.7.1-Windows.zip`
- `GridScope-0.7.1-Source.zip`
...
2. Crea la etiqueta `v0.7.1`.
3. Sube la rama y la etiqueta al repositorio.
4. Abre **Releases → Draft a new release**.
5. Selecciona `v0.7.1` y marca la versión como **Pre-release**.
